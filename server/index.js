...
const grassCtrl = require('./controllers/grassCtrl'); //Endpoint for working with data wildPokemon. This is done by requiring the controller
...
app.listen(4444, () => console.log('The server is running on port 4444')); //Allows me to define where the server is listening for requests. What port number is it listening to requests on? You should use anything between 3001-8000 because those are the least commonly used ports that wont be taken up by your computer. Adding a console.log gives a visual that the server is running. 
